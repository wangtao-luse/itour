...
public static final String COMMON_KEY_DTO="dto";
public static final String COMMON_KEY_PO="po";
//请求的key
public static final String COMMON_VO_NEEDTOTAL="needTotal";

//草稿箱
public static final String COMMON_STATUS_DRAFT="10";
//待审核
public static final String COMMON_STATUS_CHECKING="20";
//审核通过
public static final String COMMON_STATUS_CHECKED="30";
//审核不通过
