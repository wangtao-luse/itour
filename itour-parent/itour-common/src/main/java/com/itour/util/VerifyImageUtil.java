...
/**https://www.jianshu.com/p/eb190c26fb5b
 * @Author WelKin
...
public class VerifyImageUtil {
     ...
     * 源文件宽度
     */
    private static int ORI_WIDTH = 364;
    /**
     * 源文件高度
     */
    private static int ORI_HEIGHT = 141;
    /**
     * 模板图宽度
     */
     ...
     * @throws IOException
     */
    public static VerifyImage getVerifyImage(File filePath) throws IOException {
