 ...
 * 
 * import com.itour.entity.ResponseEntity; import com.itour.util.JsonUtil;
 * 
 * 
 * @ControllerAdvice public class DefaultExceptionHandler { protected Logger
 * logger = LoggerFactory.getLogger(DefaultExceptionHandler.class);
 * 
 *//**
	 * <p/>
	 * 后续根据不同的需求定制即可
