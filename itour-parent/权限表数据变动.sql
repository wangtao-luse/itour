...
INSERT INTO T_A_RIGHT_DETAIL(URL,RIGHT_No,ISLOGIN,`DESC`,ISLOG)
VALUES('/travel/updateTravelInfo','-1','authc','旅行信息修改','1');
INSERT INTO T_A_RIGHT_DETAIL(URL,RIGHT_No,ISLOGIN,`DESC`,ISLOG)
VALUES('/travel/delTravelInfo','-1','authc','旅行信息删除','1');
INSERT INTO T_A_RIGHT_DETAIL(URL,RIGHT_No,ISLOGIN,`DESC`,ISLOG)
...
INSERT INTO T_A_RIGHT_DETAIL(URL,RIGHT_No,ISLOGIN,`DESC`,ISLOG)
VALUES('/travel//infoAddPage','-1','authc','旅行信息新增','0');
...
INSERT INTO T_A_RIGHT_DETAIL(URL,RIGHT_No,ISLOGIN,`DESC`,ISLOG)
VALUES('/work/category','-1','anon','专栏查询','0');
#-前台权限表###########################-
